 ...
 * [emote.yml](emote.yml)
     * Determines how your purl.obolibrary.org/obo/emote/ redirects will be handled
     ...
     * Paste in the contents of [emote.yml](emote.yml)
 ...
 * [emote.md](emote.md)
     ...
     * Paste in the contents of [emote.md](emote.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
