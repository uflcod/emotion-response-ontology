...
## Class syncope response to emotion
...
#### URI
http://purl.bioontology.org/ontology/EMRO/0000015

#### Description
<p>A transient loss of consciousness and postural tone that happens as a result of an emotion process.</p>
...
<http://purl.bioontology.org/ontology/EMRO/0000015> a owl:Class ;
    rdfs:label "syncope response to emotion"@en ;
    ...
    dcterms:created "2026-03-05T11:54:16+00:00"^^xsd:dateTime ;
    oboInOwl:hasBroadSynonym "fainting",
        "syncope" ;
    oboInOwl:hasExactSynonym "fainting response to emotion" ;
    oboInOwl:hasRelatedSynonym "vasovagal syncope" ;
    rdfs:subClassOf <http://purl.bioontology.org/ontology/EMRO/0000007> ;
    skos:definition "A transient loss of consciousness and postural tone that happens as a result of an emotion process." .
...
#### Instances of syncope response to emotion can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="http://purl.bioontology.org/ontology/EMRO/0000015" href="class-httppurlbioontologyorgontologyemro0000015.md" class="rdfclass">syncope response to emotion</a></span>
            </th>
        </tr>       
