...
* owl:Thing
    * biological_process
        ...
        * [locomotion](class-obogo_0040011.md) 
...
#### Description
<p>Note that, in addition to forming the root of the biological process ontology, this term is recommended for the annotation of gene products whose biological process is unknown. When this term is used for annotation, it indicates that no information was available about the biological process of the gene product annotated as of the date the annotation was made; the evidence code &#39;no data&#39; (ND), is used to indicate this.</p>
...
obo:GO_0008150 a owl:Class ;
    ...
    oboInOwl:hasAlternativeId "GO:0000004",
        "GO:0007582",
        "GO:0044699" ;
    ...
    oboInOwl:inSubset <http://purl.obolibrary.org/obo/go#goslim_candida>,
    ...
    skos:definition "A biological process is the execution of a genetically-encoded biological module or program. It consists of all the steps required to achieve the specific biological objective of the module. A biological process is accomplished by a particular set of molecular functions carried out by specific gene products (or macromolecular complexes), often in a highly regulated manner and in a particular temporal sequence." .
...
#### Instances of biological_process can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="obo:GO_0008150" href="class-obogo_0008150.md" class="rdfclass">biological_process</a></span>
            </th>
        </tr>       
