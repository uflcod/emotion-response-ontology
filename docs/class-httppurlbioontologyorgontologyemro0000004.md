...
#### URI
http://purl.bioontology.org/ontology/EMRO/0000004

#### Description
<p>An emotion process that is an in-the-moment response to a perceived threat. Fear is typically associated with organized, robust visceral arousal.</p>
...
<http://purl.bioontology.org/ontology/EMRO/0000004> a owl:Class ;
    rdfs:label "fear process"@en ;
    ...
    dcterms:created "2025-11-24T20:57:08+00:00"^^xsd:dateTime ;
    rdfs:subClassOf <http://purl.bioontology.org/ontology/EMRO/0000000> ;
    skos:definition "An emotion process that is an in-the-moment response to a perceived threat. Fear is typically associated with organized, robust visceral arousal." .
...
#### Instances of fear process can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="http://purl.bioontology.org/ontology/EMRO/0000004" href="class-httppurlbioontologyorgontologyemro0000004.md" class="rdfclass">fear process</a></span>
            </th>
        </tr>       
