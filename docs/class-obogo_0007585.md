...
## Class respiratory gaseous exchange by respiratory system
...
#### Description
<p>The process of gaseous exchange between an organism and its environment. In plants, microorganisms, and many small animals, air or water makes direct contact with the organism&#39;s cells or tissue fluids, and the processes of diffusion supply the organism with dioxygen (O2) and remove carbon dioxide (CO2). In larger animals the efficiency of gaseous exchange is improved by specialized respiratory organs, such as lungs and gills, which are ventilated by breathing mechanisms.</p>
...
obo:GO_0007585 a owl:Class ;
    rdfs:label "respiratory gaseous exchange by respiratory system" ;
    oboInOwl:hasBroadSynonym "breathing",
        "respiration" ;
    oboInOwl:hasOBONamespace "biological_process" ;
    oboInOwl:id "GO:0007585" ;
    oboInOwl:inSubset <http://purl.obolibrary.org/obo/go#goslim_chembl> ;
    rdfs:isDefinedBy <http://purl.bioontology.org/ontology/emro/imports/go_import.owl> ;
    rdfs:subClassOf obo:GO_0032501 ;
    skos:definition "The process of gaseous exchange between an organism and its environment. In plants, microorganisms, and many small animals, air or water makes direct contact with the organism's cells or tissue fluids, and the processes of diffusion supply the organism with dioxygen (O2) and remove carbon dioxide (CO2). In larger animals the efficiency of gaseous exchange is improved by specialized respiratory organs, such as lungs and gills, which are ventilated by breathing mechanisms." .
...
#### Instances of respiratory gaseous exchange by respiratory system can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="obo:GO_0007585" href="class-obogo_0007585.md" class="rdfclass">respiratory gaseous exchange by respiratory system</a></span>
            </th>
        </tr>       
