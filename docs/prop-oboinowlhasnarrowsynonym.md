...
#### Description
<p>An alternative label for a class or property which has a more specific meaning than the preferred name/primary label.</p>
...
#### Usage
owl:Thing=&gt;&nbsp;_has narrow synonym_&nbsp;=&gt;&nbsp;owl:Thing
...
oboInOwl:hasNarrowSynonym a owl:AnnotationProperty ;
    ...
    skos:definition "An alternative label for a class or property which has a more specific meaning than the preferred name/primary label." .
