...
## Class motoric response to emotion
...
* [motor behavior](class-obogo_0061744.md)
...
#### URI
http://purl.bioontology.org/ontology/EMRO/0000006

#### Description
<p>A motor behavior that happens as a response to an emotion process. The motoric response includes muscle contractions that may move parts of the body or prevent the body from moving (e.g., freezing).</p>
...
<http://purl.bioontology.org/ontology/EMRO/0000006> a owl:Class ;
    rdfs:label "motoric response to emotion"@en ;
    ...
    dcterms:created "2025-11-24T21:02:42+00:00"^^xsd:dateTime ;
    rdfs:subClassOf [ a owl:Restriction ;
            owl:onProperty obo:BFO_0000051 ;
            owl:someValuesFrom obo:GO_0006936 ],
        <http://purl.bioontology.org/ontology/EMRO/0000007>,
        obo:GO_0061744 ;
    skos:definition "A motor behavior that happens as a response to an emotion process. The motoric response includes muscle contractions that may move parts of the body or prevent the body from moving (e.g., freezing)." .
...
#### Instances of motoric response to emotion can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="http://purl.bioontology.org/ontology/EMRO/0000006" href="class-httppurlbioontologyorgontologyemro0000006.md" class="rdfclass">motoric response to emotion</a></span>
            </th>
        </tr>       
