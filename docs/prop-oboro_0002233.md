...
#### Description
<p>p has input c iff: p is a process, c is a material entity, c is a participant in p, c is present at the start of p, and the state of c is modified during p.</p>
...
#### Usage
owl:Thing=&gt;&nbsp;_has input_&nbsp;=&gt;&nbsp;owl:Thing
