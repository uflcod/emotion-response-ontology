...
#### Description
<p>An alternative label for a class or property which has a more general meaning than the preferred name/primary label.</p>
...
#### Usage
owl:Thing=&gt;&nbsp;_has broad synonym_&nbsp;=&gt;&nbsp;owl:Thing
...
oboInOwl:hasBroadSynonym a owl:AnnotationProperty ;
    ...
    skos:definition "An alternative label for a class or property which has a more general meaning than the preferred name/primary label." .
