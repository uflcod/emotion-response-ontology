...
## Class motoric response to fear
...
#### URI
http://purl.bioontology.org/ontology/EMRO/0000033

#### Description
<p>A motor behavior that happens as a response to a fear process.</p>
...
<http://purl.bioontology.org/ontology/EMRO/0000033> a owl:Class ;
    rdfs:label "motoric response to fear" ;
    ...
    dcterms:created "2026-03-05T22:03:57+00:00"^^xsd:dateTime ;
    rdfs:subClassOf <http://purl.bioontology.org/ontology/EMRO/0000006>,
        <http://purl.bioontology.org/ontology/EMRO/0000020> ;
    skos:definition "A motor behavior that happens as a response to a fear process." .
...
#### Instances of motoric response to fear can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="http://purl.bioontology.org/ontology/EMRO/0000033" href="class-httppurlbioontologyorgontologyemro0000033.md" class="rdfclass">motoric response to fear</a></span>
            </th>
        </tr>       
