...
#### Description
<p>A synonym type for misnomers, i.e., a synonym that is not technically correct but is commonly used anyway</p>
...
#### Usage
owl:Thing=&gt;&nbsp;_misnomer_&nbsp;=&gt;&nbsp;owl:Thing
...
obo:OMO_0003007 a owl:AnnotationProperty ;
    rdfs:label "misnomer" ;
    ...
    skos:definition "A synonym type for misnomers, i.e., a synonym that is not technically correct but is commonly used anyway" .
