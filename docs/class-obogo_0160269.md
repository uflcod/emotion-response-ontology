...
#### URI
http://purl.obolibrary.org/obo/GO_0160269

#### Description
<p>The regulated release of sweat from the sweat glands.</p>
...
obo:GO_0160269 a owl:Class ;
    rdfs:label "sweat secretion" ;
    obo:IAO_0000233 "https://github.com/geneontology/go-ontology/issues/30274."^^xsd:anyURI ;
    oboInOwl:created_by "rynl" ;
    oboInOwl:creation_date "2025-05-19T20:55:14Z" ;
    oboInOwl:hasExactSynonym "perspiration",
        "perspiring",
        "sweating" ;
    oboInOwl:hasOBONamespace "biological_process" ;
    oboInOwl:id "GO:0160269" ;
    rdfs:isDefinedBy <http://purl.bioontology.org/ontology/emro/imports/go_import.owl> ;
    rdfs:subClassOf obo:GO_0007589,
        obo:GO_0032941 ;
    skos:definition "The regulated release of sweat from the sweat glands." .
...
#### Instances of sweat secretion can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="obo:GO_0160269" href="class-obogo_0160269.md" class="rdfclass">sweat secretion</a></span>
            </th>
        </tr>       
