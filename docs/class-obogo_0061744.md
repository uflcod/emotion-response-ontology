...
#### URI
http://purl.obolibrary.org/obo/GO_0061744

#### Description
<p>The specific neuromuscular movement of a single organism in response to external or internal stimuli.</p>
...
obo:GO_0061744 a owl:Class ;
    rdfs:label "motor behavior" ;
    oboInOwl:created_by "dph" ;
    oboInOwl:creation_date "2015-11-09T12:43:11Z" ;
    oboInOwl:hasOBONamespace "biological_process" ;
    oboInOwl:id "GO:0061744" ;
    rdfs:isDefinedBy <http://purl.bioontology.org/ontology/emro/imports/go_import.owl> ;
    rdfs:subClassOf obo:GO_0007610 ;
    skos:definition "The specific neuromuscular movement of a single organism in response to external or internal stimuli." .
...
#### Instances of motor behavior can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="obo:GO_0061744" href="class-obogo_0061744.md" class="rdfclass">motor behavior</a></span>
            </th>
        </tr>       
