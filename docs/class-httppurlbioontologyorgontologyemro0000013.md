...
## Class cognitive response to emotion
...
#### URI
http://purl.bioontology.org/ontology/EMRO/0000013

#### Description
<p>A cognitive process that happens as a response to an emotion process.</p>
...
<http://purl.bioontology.org/ontology/EMRO/0000013> a owl:Class ;
    rdfs:label "cognitive response to emotion"@en ;
    ...
    dcterms:created "2025-12-17T17:11:45+00:00"^^xsd:dateTime ;
    rdfs:subClassOf <http://purl.bioontology.org/ontology/EMRO/0000007>,
        obo:GO_0050890 ;
    skos:definition "A cognitive process that happens as a response to an emotion process." .
...
#### Instances of cognitive response to emotion can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="http://purl.bioontology.org/ontology/EMRO/0000013" href="class-httppurlbioontologyorgontologyemro0000013.md" class="rdfclass">cognitive response to emotion</a></span>
            </th>
        </tr>       
